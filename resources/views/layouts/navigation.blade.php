    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('skills.myskills')" :active="request()->routeIs('skills')">
                        {{ __('My Skills') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('announcements.myapplications')" :active="request()->routeIs('announcements')">
                        {{ __('My Application') }}
                    </x-nav-link>
                </div>
                @endif
